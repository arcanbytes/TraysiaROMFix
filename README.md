...
- Para traducir el juego a otro idioma se añade `translate_spanish.py`, que exporta todas las cadenas en castellano a un JSON editable y permite reinsertarlo tras la traducción.
